...
httpd_uri_t WifiControls::uri_get = { "/uri", HTTP_GET, WifiControls::get_uri_handler, NULL};

/* URI handler structure for POST /uri */
httpd_uri_t WifiControls::uri_post = { "/uri", HTTP_POST, WifiControls::get_uri_handler, NULL};
